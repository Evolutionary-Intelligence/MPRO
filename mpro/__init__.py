"""MPRO is a Matrix-based pure-Python library of Population-based randomized
    ...
    Its goal is to provide *high-performance* and *elegant* implementations
    for black-box and derivative-free optimization (BBO/DFO) entirely within
    a *unified*, *standardized*, *easy-to-use* programming interface.
"""
