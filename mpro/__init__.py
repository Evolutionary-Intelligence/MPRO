"""MPRO is a Matrix-based pure-Python library of Population-based Randomized
    ...
    Although this open-source Python library is initially based on PyPop7,
    the main difference between MPRO and PyPop7 lies on that the former
    seeks to maximize the performance of *batch* evaluations and update of
